...
description: "Create distinctive, production-grade frontend interfaces with intentional aesthetics, high craft, and non-generic visual identity. Use when building or styling web UIs, components, pages, dashboards, or any visual interface where a unique brand feel is required. This skill enforces strict typography, color theory, spatial layout, and motion rules to avoid 'generic AI' or 'template-like' designs."
risk: unknown
source: community
...
## When to Use
This skill is applicable when the user wants to design or build a frontend interface that stands out from generic styles. It should be invoked before any creative frontend work to establish a strong visual foundation.
